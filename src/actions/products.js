...
export const getAllProducts = () => dispatch => {
  ...
  products.map( product => (
    dispatch(addProduct(
      ...
      product.taxon_names,
      true,
      parseInt(product.master.price),
      product.master.promo_price === null ? parseInt(product.master.price) : parseInt(product.master.promo_price),
      product.master.id,
  ...
  products.map( product => (
    product.variants.map(variant =>
      dispatch(addProduct(
        ...
        variant.promo_price === null ? parseInt(variant.price) : parseInt(variant.promo_price),
        variant.id,
